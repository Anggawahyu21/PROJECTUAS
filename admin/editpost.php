...
$id = $_GET["id"];
$edit = query("SELECT * FROM data_posting WHERE id_post=$id")[0];
...
if (isset($_POST["submit"])){
    ...
    echo "
        <script>
            ...
            document.location.href='editpost.php';
        </script>";
}
}
?>
...
<body>
  ...
  <form action="" method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" name="id_post" value="<?= $edit["id_post"]; ?>">
    <h3 class="text-success">Judul</h3>
    <hr>
      <input class="input" type="text" name="judul" id="judul" autocomplete="off" value="<?= $edit["judul"];?>" required ><br><br>
    <h3 class="text-success">Isi</h3>
    <hr>
		<textarea name="isi" cols="60" rows="10" value="<?= $edit["isi"];?>" ></textarea>
		<br/>
